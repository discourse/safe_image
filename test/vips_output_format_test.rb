...
module SafeImage
  ...
  class VipsOutputFormatTest < TestCase
    def test_no_shrink_downsize_to_another_format_reencodes
      ...
      SafeImage.downsize(input: PNG, output: jpg, dimensions: "9999x9999>", optimize: false, max_pixels: JPG_PIXELS)
    ...
    def test_noop_same_format_downsize_drops_input_metadata
      ...
      SafeImage.downsize(input: marked, output: out, dimensions: "200%", optimize: false, max_pixels: JPG_PIXELS)
