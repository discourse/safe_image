...
CASES = [
  ...
  [:letter_avatar, ->(d) { DiscourseImageProcessing.letter_avatar(output: File.join(d, "letter.png"), size: 360, background_rgb: [1, 2, 3], letter: "S", font: "Adwaita-Sans") }, [360, 360, "png"]]
].freeze
